...
- Name: playwright.spec.js >> EPUB to Audiobook UI >> generate button stays disabled during active job
- Location: playwright.spec.js:226:3
...
Expected substring: "Generation queued."
Timeout: 5000ms
...
- generic [active] [ref=e1]:
  ...
  - main [ref=e8]:
    - generic [ref=e9]:
      ...
      - generic [ref=e21]:
        ...
        - generic [ref=e23]:
          ...
          - generic [ref=e40]:
            ...
            - generic [ref=e42]: Model is ready.
          - generic [ref=e45]:
            - generic [ref=e46]: Voice
            - combobox "Voice" [ref=e47]:
              - option "af_heart" [selected]
              - option "af_bella"
              - option "af_nicole"
            - generic [ref=e48]: Voices are loaded from the selected model.
          - generic [ref=e49]:
      ...
      - button "Generate Audiobook" [ref=e64] [cursor=pointer]
    - generic [ref=e65]:
      - generic [ref=e66]:
        - generic [ref=e67]:
          - heading "Status" [level=2] [ref=e68]
          - generic [ref=e69]: Completed
        - paragraph [ref=e70]: Generation complete.
        - generic [ref=e73]:
          - generic [ref=e74]:
            - generic [ref=e75]: Job
            - generic [ref=e76]: mock-job-123
          - generic [ref=e77]:
            - generic [ref=e78]: Detected Chapters
            - generic [ref=e79]: "1"
          - generic [ref=e80]:
            - generic [ref=e81]: Device
            - generic [ref=e82]: cpu
          - generic [ref=e83]:
            - generic [ref=e84]: HF Model
            - generic [ref=e85]: hexgrad/Kokoro-82M
          - generic [ref=e86]:
            - generic [ref=e87]: Run Folder
            - generic [ref=e88]: /home/lance/Documents/Code/AudiobookFromEpub/generated_audio/mock-job
          - generic [ref=e89]:
            - generic [ref=e90]: Time Started
            - generic [ref=e91]: Apr 18, 2026, 6:18:30 PM
          - generic [ref=e92]:
            - generic [ref=e93]: Last Updated
            - generic [ref=e94]: Apr 18, 2026, 6:18:30 PM
          - generic [ref=e95]:
            - generic [ref=e96]: Predicted Duration
            - generic [ref=e97]: 20s
          - generic [ref=e98]:
            - generic [ref=e99]: Predicted Finish
            - generic [ref=e100]: Apr 18, 2026, 6:18:50 PM
          - generic [ref=e101]:
            - generic [ref=e102]: Time Ended
            - generic [ref=e103]: Apr 18, 2026, 6:19:10 PM
          - generic [ref=e104]:
            - generic [ref=e105]: Time Taken
            - generic [ref=e106]: in progress
      - generic [ref=e107]:
        - heading "Generated Files" [level=2] [ref=e109]
        - list [ref=e111]:
          - listitem [ref=e112]: No generated files yet.
```
...
```ts
  ...
  150 |   });
  151 | 
  152 |   await page.route(/\/api\/jobs\/[^/]+\/status(?:\?.*)?$/, async (route) => {
  153 |     pollCount += 1;
  154 |     const stage = pollCount === 1 ? 'queued' : pollCount === 2 ? 'running' : 'completed';
  155 |     await route.fulfill(jsonResponse(mockJobStatus(stage)));
  156 |   });
  157 | 
  158 |   await page.route(/\/api\/jobs\/[^/]+\/files(?:\?.*)?$/, async (route) => {
  159 |     await route.fulfill(jsonResponse({ files: [] }));
  160 |   });
  161 | }
  162 | 
  163 | // Helper: ensure fixture epub exists (created by run script) or fail fast
  164 | if (!fs.existsSync(FIXTURE_EPUB)) {
  165 |   console.error('Missing EPUB fixture:', FIXTURE_EPUB);
  166 | }
  167 | 
  168 | test.describe('EPUB to Audiobook UI', () => {
  169 |   test('single-file happy path', async ({ page, context }) => {
